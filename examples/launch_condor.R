...
### This script launches a job on Condor through CondorBox and retrieves the output from the remote server
### this script is useful when the job requires more computational resources and time than the local machine can provide
### this script is tailored for the Pacific Community's Oceanic Fisheries Programme (OFP) and may require modifications for other use cases
